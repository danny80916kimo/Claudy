...
#define LV_FONT_SIMSUN_16_CJK            0  /*replaced by font_claudy_cjk24 (full TC coverage)*/
...
#define LV_FONT_FMT_TXT_LARGE 1  /*font_claudy_cjk24 (full CJK) exceeds 16-bit offsets*/
