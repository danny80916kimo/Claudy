...
# + CJK Extension A + Compatibility Ideographs — full Traditional Chinese plus
# common punctuation (em-dash, smart quotes, ellipsis) so messages never box out.
#
...
npx -y lv_font_conv@1.5.3 \
  ...
  --range 0x3400-0x4DBF --range 0x4E00-0x9FFF --range 0xF900-0xFAFF --range 0xFF00-0xFFEF \
